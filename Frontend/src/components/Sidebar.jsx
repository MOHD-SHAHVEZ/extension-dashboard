  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-72 bg-white shadow-[0_1px_8px_rgba(0,0,0,0.04)] z-50 flex flex-col justify-between">
      ...
      <div className="flex flex-col">
        {/* Brand */}
        <div className="min-h-16 px-5 py-2.5 flex items-center gap-3 border-b border-slate-100">
          <div className="w-9 h-9 rounded-xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-600/20 shrink-0">
            <span className="material-symbols-outlined text-white text-[20px]">backpack</span>
          </div>
          <BrandMark />
        </div>
